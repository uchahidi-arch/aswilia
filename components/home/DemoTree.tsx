...
/* ──────────────────────────────────────────────────────────
   DemoTree — Arbre exemple statique d'Abdillah Msafoumou
────────────────────────────────────────────────────────── */
...
/* ── Données ── */
const GP_PP: P = { ini: 'FF', prenom: 'Fey Foumou',  nom: 'FOUMNAOU',            hinya: 'Fwambaya',     deceased: true, genre: 'F', role: 'G-Père' };
const GP_MP: P = { ini: 'DD', prenom: 'Djananema',    nom: 'DJOUMBE FOUMOU',      hinya: 'Fwambaya',     deceased: true, genre: 'F', role: 'G-Mère' };
const GP_PM: P = { ini: 'SA', prenom: 'Saïd Hamza',   nom: 'ABDALLAH I EL MACELI',                       deceased: true, genre: 'M', role: 'G-Père' };
const GP_MM: P = { ini: 'MM', prenom: 'Moina Wetrou', nom: 'MOUIGNI MKOU',        hinya: 'Matsa Pirusa', deceased: true, genre: 'F', role: 'G-Mère' };
const PERE: P  = { ini: 'MF', prenom: 'Msafoumou',    nom: 'FEY FOUMOU',          hinya: 'Fwambaya',     deceased: true, genre: 'M', role: 'Père' };
const MERE: P  = { ini: 'MS', prenom: 'Moina Anziza', nom: 'SAÏD HAMZA',          hinya: 'Matsa Pirusa', deceased: true, genre: 'F', role: 'Mère' };
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <div className="focus-card M-focus" style={{ minWidth: 160, pointerEvents: 'none' }}>
              <div className="focus-photo" style={{ background: GREEN }}>AM</div>
