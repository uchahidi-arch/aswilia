...
export default function ProfilPage() {
  ...
  const [infoIle,     setInfoIle]     = useState('');
  ...
  return (
    <div style={{ maxWidth: '620px', margin: '0 auto', padding: '40px 24px 60px' }}>
      ...
      <div style={card}>
        ...
        <div style={row}>
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ fontSize: '12px', color: 'var(--t3)', marginBottom: '4px' }}>Île d'origine</div>
            <select
              className="f-input"
              value={infoIle}
              onChange={e => setInfoIle(e.target.value)}
              style={{ fontSize: '14px' }}
            >
          ...
          {!confirmDelete ? (
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', gap: '8px' }}>
                <a
                  href={`mailto:contact@aswilia.com?subject=Suppression%20de%20compte&body=Bonjour%2C%0A%0AJe%20souhaite%20supprimer%20mon%20compte%20Aswilia.%0AEmail%20%3A%20${encodeURIComponent(user?.email || '')}`}
                  style={{
