    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <header style={{
        ...
        <Link href="/" style={{ textDecoration: 'none' }}>
          <Image src="/logo.png" alt="Aswilia" width={120} height={33} style={{ objectFit: 'contain', width: 'auto', height: '33px' }} />
        </Link>
      ...
      <main style={{ flex: 1, maxWidth: '720px', margin: '0 auto', padding: '48px 24px', width: '100%' }}>
        ...
        <div style={{ marginBottom: '40px' }}>
          ...
          <p style={{ fontSize: '14px', color: 'var(--t3)', marginTop: '12px', lineHeight: 1.7 }}>
            Aswilia est une plateforme de mémoire généalogique comorienne. Nous prenons la protection de vos données très au sérieux.
          </p>
        </div>
        ...
        {[
          {
            ...
            content: (
              <>
                <p>Toutes les informations que vous saisissez sur Aswilia — arbres généalogiques, fiches de personnes, liens familiaux — restent votre propriété exclusive.</p>
            ...
            content: (
              <>
                ...
                <ul style={{ paddingLeft: '20px', lineHeight: 2 }}>
                  ...
                  <li><strong>Votre île d'origine</strong> (facultatif) — pour les suggestions géographiques</li>
                </ul>
          ...
          },
          {
            ...
            content: (
              <>
                <p>Aswilia s'engage formellement à ne jamais :</p>
                <ul style={{ paddingLeft: '20px', lineHeight: 2 }}>
            ...
            content: (
              <>
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: '13px', fontWeight: 600, color: 'var(--t1)' }}>U-Data · Équipe Aswilia</div>
                  <div style={{ fontSize: '13px', color: 'var(--green)', marginTop: '4px' }}>contact@aswilia.com</div>
                </div>
